...
(
    ...
    year_rate           DECIMAL(20, 6) NOT NULL COMMENT '年利率',
    breach_fee_rate     DECIMAL(20, 6) NOT NULL COMMENT '违约金日利率，百分号前面的部分',
    term_late_fee_rate  DECIMAL(20, 6) NOT NULL COMMENT '期款滞纳金日利率，百分号前面的部分',
    loan_late_fee_rate  DECIMAL(20, 6) NOT NULL COMMENT '整笔贷款滞纳金日利率，百分号前面的部分',
    repay_day           TINYINT        NOT NULL COMMENT '到期还款日',
    grace_day           TINYINT        NOT NULL COMMENT '宽限天数',
    ...
    loan_late_fee       DECIMAL(20, 6) NOT NULL COMMENT '整笔贷款滞纳金',
...
(
    ...
    term_late_fee_rate DECIMAL(20, 6) NOT NULL COMMENT '期款滞纳金日利率，百分号前面的部分',
    loan_late_fee_rate DECIMAL(20, 6) NOT NULL COMMENT '整笔贷款滞纳金日利率，百分号前面的部分',
    principal          DECIMAL(20, 6) NOT NULL DEFAULT '0' COMMENT '本金',
    interest           DECIMAL(20, 6) NOT NULL DEFAULT '0' COMMENT '利息',
    overdue_fee        DECIMAL(20, 6) NOT NULL DEFAULT '0' COMMENT '罚息',
    guarantee_fee      DECIMAL(20, 6) NOT NULL DEFAULT '0' COMMENT '担保费',
    breach_fee         DECIMAL(20, 6) NOT NULL DEFAULT '0' COMMENT '违约金',
    term_late_fee      DECIMAL(20, 6) NOT NULL DEFAULT '0' COMMENT '期款滞纳金',
    last_repay_date    DATETIME       NOT NULL COMMENT '上一次的还款时间',
