...
(
    ...
    comp_principal     DECIMAL(20, 2) NOT NULL DEFAULT '0' COMMENT '本金',
    comp_interest      DECIMAL(20, 2) NOT NULL DEFAULT '0' COMMENT '利息',
    comp_overdue_fee   DECIMAL(20, 2) NOT NULL DEFAULT '0' COMMENT '罚息',
    comp_loan_date     DATETIME COMMENT '整笔代偿日',
